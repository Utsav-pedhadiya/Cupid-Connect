        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="demo-inline-spacing-end d-flex justify-content-end m-2">
                    <a href="{{ route('subscriber.create') }}" class="btn btn-primary">Add New Subscription</a>
                </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" role="switch" id="change_status_{{$row->id}}" @if($row->is_active == 1) checked @endif>
                                            <label class="form-check-label" for="change_status_{{$key}}"></label>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <a class="dropdown-item" href="{{ route('subscriber.edit', ['id' => $row->id]) }}"><i class="bx bx-edit-alt me-1"></i> Edit</a>
                                                <a class="dropdown-item" href="{{ route('subscriber.delete', ['id' => $row->id]) }}"><i class="bx bx-trash me-1"></i> Delete</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
