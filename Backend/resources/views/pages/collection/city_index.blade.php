...
@section('content')
<div class="card p-1">
<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">City/</span>City</h4>
</div>
</br>
<div class="card p-2">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="demo-inline-spacing-end d-flex justify-content-end m-2">
                    <a href="{{ route('collection.city.add') }}" class="btn btn-primary">Add New City</a>
                </div>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <a class="dropdown-item" href="{{ route('collection.city.delete', ['id' => $row->id]) }}"><i class="bx bx-trash me-1"></i> Delete</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
