<div class="form p-2">
          <form id="formAccountSettings" method="POST" action="{{ route('adminuser.update') }}" enctype="multipart/form-data">
          @csrf
          ...
          <div class="row g-2">
              ...
              <input type="number" name="mobile_no" id="mobile_no" class="form-control" value="{{$data->mobile_no}}">
              </div>
          </div>
          <div class="row g-2">
              <div class="col-6">
