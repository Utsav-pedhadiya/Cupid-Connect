                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" href="javascript:void(0);" onclick="loadOffcanvasContent('{{ route('payment.show', $row->id) }}')">
                                                    <i class="bx bx-show me-2"></i> Show
                                                </a>
                                                <a class="dropdown-item" href="{{ route('ajax.update_payment', $row->id) }}"><i class="bx bx-check me-1"></i>Check Status</a>
                                                <a class="dropdown-item" href="javascript:void(0);" onclick="loadModalContent('{{ route('ajax.payment_detail', $row->id) }}')"><i
                                                        class="bx bx-edit-alt me-1"></i>Edit</a>
                                                <!-- <a class="dropdown-item" onclick="deleteRow('{{$row->id}}')"><i class="bx bx-trash me-1"></i> Delete</a> -->
                                                <a class="dropdown-item" href="{{ route('payment.refund', $row->id) }}"><i class="bx bx-undo"></i>Refund</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title" id="modalCenterTitle">Subscription Payment Edit</h5>
